...
'<': '<',
'<=': '<=',
'<script>alert("Lütfen email adresinizi doğru bir şekilde yazınız")</script>': '<script>alert("Lütfen email adresinizi doğru bir şekilde yazınız")</script>',
'=': '=',
'>': '>',
'>=': '>=',
...
'Back': 'Geri',
'Bu isim listede yok': 'Bu isim listede yok',
...
'Lütfen email adresinizi doğru bir şekilde yazınız': 'Lütfen email adresinizi doğru bir şekilde yazınız',
