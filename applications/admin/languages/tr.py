...
'at char %s': '%s karateri üzerinde',
'at line %s': '%s satırı üzerinde',
...
'design': 'tadarla',
'Detailed traceback description': 'Ayrıntılı nedenini bulma tanımı',
...
'Editor': 'Düzenleyici',
'Enable': 'Etkinleştir',
'Enable Close-Tag': 'Kapatma etiketini etkinleştir',
...
'exposes:': 'sergile:',
'extends': 'genişlet',
'failed to compile file because:': 'derlenemedi çünkü:',
...
'Highlight current line': 'Üzerinde bulunduğun satırı vurgula',
'Hits': 'Vuruşlar',
'Home': 'Anasayfa',
...
'includes': 'içerir',
'Indent with tabs': '«tab» ile girintile',
'index': 'indeks',
...
'switch to : db': 'geç : db',
'Tab width (# characters)': '(# karakter) ile «tab»la',
'table': 'tablo',
'Temporary': 'Geçici',
'test': 'test',
